...
export const GET = async () => {
	...
	try {
		...
		const university = user.university; // User's university
		const googleUser = user.googleUser; // Whether the user is a Google user

		// Return the user details as a JSON response
		return new NextResponse(
			JSON.stringify({ username, university, googleUser }), // Return user details in JSON format
